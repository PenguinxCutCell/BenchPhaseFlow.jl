...
# Convergence study for a one-phase Stefan test case based on the reference setup.
...
function main(; nx_list=nothing, csv_path=nothing)
    ...
    data = run_stefan_case_convergence(nx_vals)
...
results = main()
println("Stefan 1ph case convergence written to:\n  ", results.csv_path)
