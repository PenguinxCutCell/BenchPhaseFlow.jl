...
@testset "Navier–Stokes + passive scalar pure conduction" begin
    nx, ny = 48, 32
    ...
    @info "Navier–Stokes + heat pure conduction sanity" grid="$(nx)x$(ny)" Δt=Δt T_end=T_end
    ...
    @info "Pure conduction sanity check passed."
end
